...
Route::middleware(['role:admin'])->group(function () {
        ...
        Route::get('/admin/barang', [Barang::class, 'index']);
        ...
        Route::post('/admin/peminjaman-barang', [PeminjamanBarangController::class, 'store']); // Menyimpan data peminjaman
        Route::get('/admin/peminjaman-barang', [PeminjamanBarangController::class, 'index']); // Melihat semua data peminjaman
        ...
        Route::post('/admin/peminjaman', [PeminjamanCotroller::class, 'store']); // Menyimpan data peminjaman
        Route::get('/admin/peminjaman', [PeminjamanCotroller::class, 'index']); // Melihat semua data peminjaman
        ...
        Route::get('/admin/laporan-barang', [Barang::class, 'laporan'])->name('laporan-barang');
        Route::get('/admin/laporan-barang/pdf', function () {
            $barang_inventaris = barang_inventaris::all(); // Change to the correct variable
            $pdf = Pdf::loadView('admin.Laporan_Barang.pdf', compact('barang_inventaris')); // Pass the correct variable
            return $pdf->download('laporan-barang.pdf');
        });

        Route::get('/admin/jenis-barang', [JenisBarangController::class, 'index']);
        Route::post('/admin/jenis-barang', [JenisBarangController::class, 'store'])->name('jenis-barang.store');
        ...
        Route::get('/admin/asal-barang', [Barang_Asal_Controller::class, 'index']);
...
Route::middleware(['role:user'])->group(function () {
        ...
        Route::get('/user/barang', [Barang::class, 'index']);
        ...
        Route::post('/user/peminjaman-barang', [PeminjamanBarangController::class, 'store']); // Menyimpan data peminjaman
        Route::get('/user/peminjaman-barang', [PeminjamanBarangController::class, 'index']); // Melihat semua data peminjaman
        ...
        Route::post('/user/peminjaman', [PeminjamanCotroller::class, 'store']); // Menyimpan data peminjaman
        Route::get('/user/peminjaman', [PeminjamanCotroller::class, 'index']); // Melihat semua data peminjaman
...
Route::middleware(['role:superuser'])->group(function () {
        ...
        Route::get('/superuser/barang', [Barang::class, 'index']);
        ...
        Route::get('/superuser/pengguna', [UserController::class, 'index']);
        ...
        Route::get('/superuser/peminjaman-barang', [PeminjamanBarangController::class, 'index']); // Melihat semua data peminjaman
        ...
        Route::get('/superuser/peminjaman', [PeminjamanCotroller::class, 'index']); // Melihat semua data peminjaman
        ...
        Route::get('/superuser/jenis-barang', [JenisBarangController::class, 'index']);
        ...
        Route::get('/superuser/asal-barang', [Barang_Asal_Controller::class, 'index']);
        ...
        Route::get('/superuser/pengembalian', [PengembalianController::class, 'index']); 
