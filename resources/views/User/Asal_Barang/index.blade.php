...
@section('content')
    ...
    @include('User/Asal_Barang.modals')
@endsection
    ...
    <script>
        $('#formModal').on('show.bs.modal', function(e) {
            ...
            if (mode == 'edit') {
                ...
                modal.find('.modal-body form').attr('action', '{{ url('/user/asal-barang') }}/' +
                    id_asal_br);
